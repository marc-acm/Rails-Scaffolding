...
class SuppliersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create supplier" do
    assert_difference('Supplier.count') do
      post suppliers_url, params: { supplier: { address: @supplier.address, name: @supplier.name, tel_no: @supplier.tel_no } }
    end
  ...
  test "should update supplier" do
    patch supplier_url(@supplier), params: { supplier: { address: @supplier.address, name: @supplier.name, tel_no: @supplier.tel_no } }
